        ...
        <div className="relative mx-auto max-w-[1450px] px-8 pb-20 pt-28">
          ...
          <div className="relative mt-10">
            ...
            <button
              ...
              className="absolute left-[-24px] top-1/2 z-20 flex h-24 w-24 -translate-y-1/2 items-center justify-center rounded-full border-[3px] border-sp-deep-brown bg-[#D7B48A] text-sp-deep-brown shadow-[0_8px_0_rgba(0,0,0,0.08)] transition-transform duration-200 hover:scale-105"
            >
            ...
            <button
              ...
              className="absolute right-[-24px] top-1/2 z-20 flex h-24 w-24 -translate-y-1/2 items-center justify-center rounded-full border-[3px] border-sp-deep-brown bg-[#D7B48A] text-sp-deep-brown shadow-[0_8px_0_rgba(0,0,0,0.08)] transition-transform duration-200 hover:scale-105"
            >
            ...
            <div className="overflow-hidden rounded-[2.6rem] border-[3px] border-sp-deep-brown bg-white shadow-[12px_12px_0_rgba(0,0,0,0.08)]">
              ...
              <div
                className={cn(
                  "grid min-h-[560px] grid-cols-[0.95fr_1.05fr]",
              ...
              >
                ...
                <div className="relative overflow-hidden p-10">
                  ...
                  {/* giant number */}
                  <div className="pointer-events-none absolute right-8 top-6 font-serif text-[12rem] leading-none text-sp-deep-brown/8">
                    {activeProgram.step}
                  </div>
                  ...
                  <div className="relative flex h-full flex-col justify-between rounded-[2.2rem] border-[3px] border-sp-deep-brown bg-white/70 p-8 shadow-[8px_8px_0_rgba(0,0,0,0.06)] backdrop-blur-sm">
                    <div>
                      ...
                      <div className="mt-6 grid grid-cols-2 gap-4">
                        <div className="rounded-[1.4rem] border-[2px] border-sp-deep-brown bg-[#FFF8F4] p-5">
                        ...
                        <div className="rounded-[1.4rem] border-[2px] border-sp-deep-brown bg-[#F9FCFF] p-5">
                          <p className="text-[10px] font-black uppercase tracking-[0.16em] text-sp-hot-pink">
                            Focus
                          </p>
                          <p className="mt-3 font-serif text-[1.5rem] leading-tight text-sp-deep-brown">
                      ...
                      <div className="mt-6 rounded-[1.6rem] border-[2px] border-sp-deep-brown bg-[#FFFDF8] p-6">
                        <p className="text-[10px] font-black uppercase tracking-[0.16em] text-sp-hot-pink">
                          What this offers
                        </p>
      ...
      <section className="bg-sp-cream px-4 py-16 xl:hidden">
        <div className="mx-auto max-w-6xl">
          ...
          <div className="mt-8 overflow-hidden rounded-[2rem] border-[3px] border-sp-deep-brown bg-white shadow-[8px_8px_0_0_rgba(0,0,0,0.08)]">
            <div className={cn("p-6 sm:p-8", activeProgram.panelAccent)}>
              ...
              <div className="mt-6 rounded-[1.5rem] border-[2px] border-sp-deep-brown bg-white/70 p-5">
                <p className="text-[10px] font-black uppercase tracking-[0.16em] text-sp-hot-pink">
                  What this offers
                </p>
