...
export function Method() {
  ...
  return (
    <section id="method" className="relative bg-[#F5F0E6] pb-32">
      ...
      <div ref={containerRef} style={{ position: "relative" }} className="relative mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-10">
...
function StickyPanel({ card, index, progress, total }: { card: MethodCard; index: number; progress: any; total: number }) {
  ...
  return (
    <div style={{ height: "100vh" }}>
      <div
        className="sticky top-0 flex items-center justify-center h-screen w-full px-4 sm:px-6"
        style={{
      ...
      >
        <article
          className="grid h-[85vh] max-h-[800px] w-full max-w-[1400px] overflow-hidden rounded-[20px] sm:rounded-[32px] border-[3px] sm:border-[4px] border-black bg-[#FDF9F3] shadow-[8px_8px_0_0_rgba(0,0,0,1)] sm:shadow-[15px_15px_0_0_rgba(0,0,0,1)] lg:grid-cols-[1.1fr_0.9fr]"
        >
          {/* IZQUIERDA: TEXTO */}
