...
function StickyPanel({
  ...
  return (
    ...
    >
      <article className="grid h-[80vh] w-full overflow-hidden rounded-[24px] border-[3px] border-black bg-[#FDF9F3] shadow-[8px_8px_0_0_rgba(0,0,0,1)] sm:rounded-[34px] lg:grid-cols-[1.1fr_0.9fr] mx-4 sm:mx-6">
