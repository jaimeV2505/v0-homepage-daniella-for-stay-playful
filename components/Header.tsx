  ...
  return (
    <header
      className={`sticky top-0 z-50 border-b-[3px] border-black transition-all duration-300 ${isScrolled
          ? "bg-[#DDBAF0]/92 backdrop-blur-md"
          : "bg-[#DDBAF0]"
        }`}
    >
      <div className="mx-auto max-w-[1720px] px-4 sm:px-6 lg:px-8">
        <div className="grid h-[86px] grid-cols-[1fr_auto_1fr] items-center gap-4 lg:h-[110px]">
          {/* LEFT NAV */}
          ...
          <div className="flex items-center justify-center">
            <Link
              href="/"
              className="text-center font-serif text-[2.8rem] font-black uppercase leading-none tracking-[-0.06em] text-black transition-transform duration-200 hover:scale-[1.01] sm:text-[3.4rem] lg:text-[4.5rem]"
            >
              Stay Playful
            </Link>
          </div>
          ...
          <div className="hidden items-center justify-end gap-4 lg:flex xl:gap-5">
            ...
            <Link
              href="#contact"
              className="inline-flex items-center justify-center border-[3px] border-black bg-[#F8E9E2] px-7 py-3 text-sm font-black uppercase tracking-[0.08em] text-black shadow-[6px_6px_0_0_rgba(0,128,80,1)] transition-transform duration-200 hover:-translate-y-0.5"
            >
              Book a Call
            </Link>
          </div>
                  ...
                  <div className="flex flex-1 flex-col justify-between px-6 py-8">
                    ...
                    <div className="mt-10 space-y-4 border-t-[3px] border-black pt-6">
                      ...
                      <Link
                        href="#contact"
                        onClick={() => setIsOpen(false)}
                        className="inline-flex w-full items-center justify-center border-[3px] border-black bg-[#F8E9E2] px-5 py-4 text-sm font-black uppercase tracking-[0.12em] text-black shadow-[8px_8px_0_0_rgba(0,128,80,1)]"
                      >
                        Book a Call
                      </Link>
                    </div>
