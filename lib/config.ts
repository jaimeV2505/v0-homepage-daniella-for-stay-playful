...
export const translations = {
  sv: {
    ...
    brand: {
      eyebrow: "",
      heading: " 🚨VARNING TEST JAIME: Stay Playful kan orsaka följande biverkningar:",
    ...
    contact: {
      ...
      body2: "Stay playful handlar om stöd hela vägen - en början på något nytt och genomtänkt för att det här ska bli en del av ditt nya liv",
  ...
  en: {
    ...
    contact: {
      ...
      body2: "Stay Playful is about support all the way — the beginning of something new, thoughtfully designed to become a natural part of your new life.",
